export const generateMockCalendarData = (indexCount) => {
  try {
    ...
    let latestReading2 = {
      ...
      //   creator: { email: "bds6052@gmail.com", self: true },
      //   organizer: { email: "bds6052@gmail.com", self: true },
      //   start: { dateTime: "2023-12-17T19:00:00Z", timeZone: "Europe/London" },
      //   end: { dateTime: "2023-12-17T20:00:00Z", timeZone: "Europe/London" },
